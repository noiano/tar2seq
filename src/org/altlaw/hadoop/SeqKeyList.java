 ...
 * permissions and lim itations under the License.
 */
...
public class SeqKeyList {
    ...
    public void execute() throws Exception {
        ...
        try {
            ...
            Writable key = (Writable)ReflectionUtils.newInstance(reader.getKeyClass(), setup.getConf() );
            Text value = (Text)ReflectionUtils.newInstance(reader.getKeyClass(), setup.getConf() );
